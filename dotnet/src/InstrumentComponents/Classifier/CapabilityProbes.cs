...
internal static class CapabilityProbes
{
    ...
    internal static readonly string[] PwrmeterReadonlyCommands =
        [":UNIT:POW?", "UNIT:POW?", ":SENS:POW:RANG:AUTO?", "SENS:POW:RANG:AUTO?"];

    internal static readonly string[] SpecanReadonlyCommands =
        [":FREQ:CENT?", "FREQ:CENT?", ":FREQ:SPAN?", "FREQ:SPAN?", ":BAND?", "BAND?"];
