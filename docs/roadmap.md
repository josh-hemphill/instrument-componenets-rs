...
Dual-native work follows [dual-native-plan.md](dual-native-plan.md). Streams A–D are merged (`latest`). Stream E is on PR #10. Stream F (this work) emits dialect-resolved SCPI for the remaining catalog classes. Next: DMM/PSU transcripts and self-hosted hardware smoke.
