...
//! ```
//!
//! See [README](https://github.com/josh-hemphill/instrument-components-rs/blob/main/README.md),
//! [getting started](https://github.com/josh-hemphill/instrument-components-rs/blob/main/docs/getting-started.md),
//! and [async guide](https://github.com/josh-hemphill/instrument-components-rs/blob/main/docs/async.md).
