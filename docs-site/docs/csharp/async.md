...
[`VisaAsyncTransport`](https://github.com/josh-hemphill/instrument-components-rs/blob/latest/dotnet/src/InstrumentComponents.Visa/VisaAsyncTransport.cs) wraps sync `VisaTransport` in `SyncAsAsyncTransport`:
